<script lang="ts">
    ...
    $: if(!!styles[selectedStyle] && Array.isArray(styles[selectedStyle].variant) && styles[selectedStyle].variant.length <= 0) selectedVar = ""

    export let style = "";
    $: style = selectedStyle + ((!!selectedVar) ? ("::" + selectedVar) : "");
